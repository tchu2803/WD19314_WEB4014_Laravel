...
<div class="card-header bg-primary text-white">
    <h3 class="mb-0"><i class="fas fa-search"></i> Tạo bài viết </h3>
</div>
                ...
                <div class="container">
                    <form action="{{ route('admins.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="tac_gia" id="tac_gia" value="{{ old('tac_gia') }}" />
                            </div>
                            @error('tac_gia')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-8">
                                <input type="checkbox" class="form-checkbox" name="trang_thai" id="trang_thai" value="1" {{ old('trang_thai') ? 'checked' : '' }} /> Đã đăng
                                <input type="checkbox" class="form-checkbox ml-2" name="trang_thai" id="trang_thai" value="0" {{ old('trang_thai') ? 'checked' : '' }} /> Chưa đăng
                            </div>
                            @error('trang_thai')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
